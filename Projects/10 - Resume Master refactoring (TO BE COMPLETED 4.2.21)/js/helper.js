...
function initializeMap() {
  ...
  */
  function createMapMarker(placeData) {
    ...
    // variables
    var lat = placeData.geometry.location.lat();  // lat from place service
    var lon = placeData.geometry.location.lng();  // long from place service
    var name = placeData.formatted_address;   // name of place from place service
    var bounds = window.mapBounds;            // current boundaries of map window
  ...
  */
  ...
  locationFinder(), and it fires off Google place searches for each location
  */
  function pinPoster(locations) {
    ...
    locations.forEach(function(place){
      ...
      // Actually searches the Google Maps API for location data and runs
      // the callback function with the search results after each search.
